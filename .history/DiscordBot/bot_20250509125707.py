...
from submitted_report import SubmittedReport
import pdb
...
class ModBot(discord.Client):
    ...
    async def handle_dm(self, message):
        ...
        if self.reports[author_id].is_report_complete():
            ...
            submitted_report = SubmittedReport(reported_author, reported_content, report_type, disinfo_type, disinfo_subtype, imminent)
            self.report_queue.append(submitted_report)
