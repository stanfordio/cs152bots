...
class ModBot(discord.Client):
    def __init__(self): 
        ...
        self.report_queue = PriorityReportQueue(3) # should equal the number of distinct priorities defined in Report.get_priority
    ...
    async def handle_dm(self, message):
        ...
        if self.reports[author_id].is_report_complete():
            ...
            submitted_report = SubmittedReport(reported_author, reported_content, report_type, disinfo_type, disinfo_subtype)
